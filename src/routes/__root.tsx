...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rotary Club of Athi River" },
      {
        name: "description",
        content: "Rotary Club of Athi River — People of action serving Machakos County, Kenya. District 9212.",
      },
      { property: "og:title", content: "Rotary Club of Athi River" },
      {
        property: "og:description",
        content: "Service Above Self — community projects, meetings and membership in Athi River.",
      },
